...
const EmployeeRegistrationModal: React.FC<EmployeeRegistrationModalProps> = ({ onClose, onRegisterComplete }) => {
            ...
            >
                ...
                <div className="px-6 pt-4">
                    <div className="flex items-center">
                        ...
                        <div className={`flex-1 h-1 mx-2 ${currentStep >= 2 ? "bg-rose-600" : "bg-gray-200"}`} />
                        <div
                            className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium ${
