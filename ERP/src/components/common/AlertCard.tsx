    ...
    ">
      ...
      <div className="p-4 space-y-2">
        <p className="text-sm text-gray-500 flex items-center"> 
          <img src='/images/productcode.svg' className='w-4 h-4 mr-1' />제품 코드: {productCode}
        </p>
        <p className="text-sm text-gray-500 flex items-center"> 
          <img src='/images/stock.svg' className='w-4 h-4 mr-1' />현재 재고: {stock}개
        </p>
        <p className="text-sm text-gray-500 flex items-center">
          <img src='/images/average.svg' className='w-4 h-4 mr-1' />평균 판매량: 일 {avgSales}개
        </p>
        <button className="
