    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
                <Link
                    to="/inventory"
                    className="p-4 rounded-lg bg-indigo-600 text-white flex items-center"
                >
                ...
                <Link
                    to="/orders"
                    className="p-4 rounded-lg bg-green-600 text-white flex items-center"
                >
                ...
                <Link
                    to="/hr"
                    className="p-4 rounded-lg bg-purple-600 text-white flex items-center"
                >
