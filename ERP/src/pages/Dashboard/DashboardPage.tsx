...
const DashboardPage = () => {
    ...
    return (
        <div>
            ...
            <div className="bg-white shadow-md rounded-lg p-4 w-139 h-90.25">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mt-6 w-284">
